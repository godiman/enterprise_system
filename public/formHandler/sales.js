...
salesForm.addEventListener('submit', (e) =>{
    ...
    const brand = salesForm.brand.value;
    const category = salesForm.category.value;
    const pakagingType = salesForm.pakagingType.value;
    const wholePrice = salesForm.wholePrice.value;
    const unitPrice = salesForm.unitPrice.value;
    const wholeQty = salesForm.wholeQty.value;
    const unitQty = salesForm.unitQty.value;
    ...
    const data = { brand, category, pakagingType, wholePrice, unitPrice, wholeQty, unitQty };

    fetch('/admin/add-sale', {
        method: 'Post',
        headers: {
